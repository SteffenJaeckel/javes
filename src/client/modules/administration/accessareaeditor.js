...
Template.accessareaeditor.created = function () {
...
Template.accessareaeditor.helpers({
    savestate : function () {
      if( false ) {
        return '';
      }
...
Template.accessareaeditor.events({
  'click #save' : function ( e ) {
    ...
    if( coords.length > 0 ) {
      ...
      Meteor.call('updateAccessAreaShape', area._id, shape, function ( e ) {
        if( e ) {
          console.log( e );
